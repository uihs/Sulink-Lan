...
var (
	...
	// User32CreateSolidBrush 为本地 fork 新增：窗口类背景画刷需要它
	// （上游没有设置 hbrBackground，见 internal/webview/webview.go 的包注释）。
	User32CreateSolidBrush = user32.NewProc("CreateSolidBrush")
)
